...
class TranslatorController extends AbstractAgentApiController
{
    ...
    #[Route('/agent/talk/translator', name: 'agent_talk_translator', methods: ['POST', 'GET'], priority: 1)]
    ...
    #[Route('/agent/stream/translator', name: 'agent_talk_stream_translator', methods: ['POST', 'GET'], priority: 1)]
    public function apiTalkStream(Request $request): StreamedResponse|JsonResponse
    {
        // Validation
        $agent = $this->apiHelperService->validateAgentAccessRequest('translator', $request);
        ...
        $translatedFilePath = $this->fileService->translateDocument($fileIds[0]);
        ...
        // Return file
        $message = sprintf('[Download translated file](%s)', $publicUrl);
