...
export const adminApi = {
  ...
  configurations: {
    ...createCrudApi<ConfigurationFilters, ConfigurationInsert, ConfigurationUpdate, { id: number; code: string; name: string; value: string; defaultValue: string; description: string | null; createdAt: Date; updatedAt: Date }>('db:admin:configurations'),
    getByCode: createInvokeWrapper<[string], { id: number; code: string; name: string; value: string; defaultValue: string; description: string | null; createdAt: Date; updatedAt: Date } | null>('db:admin:configurations:getByCode'),
    updateByCode: createInvokeWrapper<[string, string], { id: number; code: string; name: string; value: string; defaultValue: string; description: string | null; createdAt: Date; updatedAt: Date } | null>('db:admin:configurations:updateByCode'),
