...
<section class="container-page stack-lg">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <a class="btn btn--secondary" href="#/test/styleguide/base">{t('app.menu.styleguide.base')}</a>
    <a class="btn btn--secondary" href="#/test/styleguide/inputs">{t('app.menu.styleguide.inputs')}</a>
